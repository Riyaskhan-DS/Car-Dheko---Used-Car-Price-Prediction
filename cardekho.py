...
slt.image("c:/Users/USER/Pictures/wallaper/CarDekho-Feature.jpg")
# Option menu
...
if page == "CarDekho-Price Prediction":
    ...
    # Load data
    df = pd.read_csv("c:/Users/USER/Downloads/filtered_data.xls")
    ...
    with col2:
        ...
        if Submit:
            with open('c:/Users/USER/Downloads/pipeline.pkl','rb') as files:
...
# User Guide Page
    ...
    **Example Workflow:**
    ...
    slt.write("if you want to explore more cars? link will be provided below!")
